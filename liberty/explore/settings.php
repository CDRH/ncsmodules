...
function redirectAndSearch( $field, $value ) {
...
if( $themeName != '' && $fieldName != '' ) {
  //Example of input: content.php?id=ls.00001&field=text

  if ( is_null($themeName) || ($themeName == "")) {
		  print( "<h1>Error with name category</h1>" );
    print( "<h2><a href='" . IL_BASE_HREF . ">go home</a></h2>");
    exit();
  }
