...
function redirectAndSearch( $value ) {
  $URL = SOLR_BASE_HREF . "ncs]loveandseduction/select?" .
				"indent=on&" .
				"version=2.2&" .
				"q=setting:" . $value . "&" .
				"start=0&" .
...
</div><div id="related"><p></p></div></div><div id="menu"><img alt="19th Century Studies: Scenes of Love and Seduction" src="images/bigtest.jpg"><ul><li><a href="index.html">Home</a></li><li><a href="introduction.php">Introduction</a></li><li><img alt="Contexts and Themes" src="images/context.gif"></li><li><a href="explore/settings.php">Spatial Setting</a></li><li><a href="explore/themes.php">Theme</a></li><li><img alt="Browse by content type" src="images/content.gif"></li><li><a href="explore/genres.php?name=fiction">Literature&nbsp;<img alt="Fiction" src="images/fiction.gif"></a></li><li><a href="explore/genres.php?name=image">Art &amp; Illustration&nbsp;<img alt="Art and Illustration" src="images/image.gif"></a></li><li><a href="explore/genres.php?name=history">History&nbsp;<img alt="History" src="images/history.gif"></a></li><li><a href="explore/genres.php?name=commentary">Commentary&nbsp;<img alt="Commentary" src="images/commentary.gif"></a></li></ul><form action="search/search.php"><p class="search"><a href="search/index.php"><img alt="Search" src="images/search.gif">SEARCH</a><br><br><input name="keyword" id="keyword" type="text" size="20"><input type="submit" value="Go"></p></form><p style="text-align: left;"><img alt="University of Nebraska - Lincoln" src="images/unl.gif"></p></div></body></html>
<?php
}
?>
